...
\vspace*{-0.1cm}
\hspace*{-1.1cm}
\includegraphics[keepaspectratio=true,width=1.01\paperwidth]{title_slide}
\end{frame}
...
\begin{frame}{Content Delivery Networks --- A Silver Bullet?}
    \begin{itemize}
        ...
        \item{Can we extend support for dynamic data?}
    \end{itemize}
\end{frame}
...
\begin{frame}[fragile]{Apollo Overview}
    \begin{figure}
        \includegraphics[scale=0.16]{apollo_overview_simplified}
    \end{figure}
\end{frame}

\begin{frame}[fragile]{Apollo Overview}
    \begin{figure}
        \includegraphics[scale=0.16]{apollo_overview_simplified_2}
    \end{figure}
\end{frame}
...
\begin{frame}[fragile]{Prediction Routine}
    \begin{figure}
        \hspace*{-1cm}
...
\begin{frame}[fragile]{Prediction Routine}
    \begin{figure}
        \hspace*{-1cm}
        \includegraphics[scale=0.22]{apollo_cpr_6}
    \end{figure}
\end{frame}
...
\begin{frame}[fragile]{Prediction Routine}
    \begin{figure}
        \hspace*{-1cm}
        \includegraphics[scale=0.22]{apollo_cpr_7}
    \end{figure}
\end{frame}
...
\begin{frame}[fragile]{Prediction Routine}
    \begin{figure}
        \hspace*{-1cm}
        \includegraphics[scale=0.22]{apollo_cpr_8}
    \end{figure}
\end{frame}
...
\begin{frame}[fragile]{TPC-W Results}
    \begin{figure}
        \center
        \includegraphics[scale=0.8]{apollo_tpcw}
    \end{figure}
\end{frame}
...
\begin{frame}[fragile]{Learning Over Time}
    \begin{figure}
        \center
        \includegraphics[scale=0.8]{apollo_30_intervals}
    \end{figure}
\end{frame}
...
\begin{frame}[fragile]{Workload Change}
    \begin{figure}
        \center
        \includegraphics[scale=0.14]{apollo_wl_change}
    \end{figure}
\end{frame}

\begin{frame}[fragile]{Predictive Caching \emph{Works}}
    \begin{itemize}
        \item{\alert{Online learning} enables workload pattern discovery and adapts to client behaviour changes}
        \item{\alert{Predictive caching} is an effective tool to reduce application latency}
    \end{itemize}
\end{frame}
