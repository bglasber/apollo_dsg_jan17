...
\begin{frame}{Extending Edge Cache Support}
    \begin{figure}
        \center
        \hspace*{-1.5cm}
        \includegraphics[scale=0.17]{apollo_edge_cache_apollo}
    \end{figure}
\end{frame}
...
\begin{frame}{Extending Edge Cache Support}
    \begin{figure}
        \center
        \hspace*{-1.5cm}
        \includegraphics[scale=0.17]{apollo_ec_upd_2}
    \end{figure}
\end{frame}
...
\begin{frame}{Apollo: Caching Dynamic Data on a Global Scale}
    ...
    \begin{itemize}
        \visible<2->{
            \item{\alert{Adaptive} method to cache based on client behaviour patterns}
        }
        \visible<3->{
            \item{\alert{Computationally efficient} means of managing updates to cached data}
        }
    \end{itemize}
\end{frame}
